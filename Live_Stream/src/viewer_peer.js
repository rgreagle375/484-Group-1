/**
 * This file demonstrates the process of starting WebRTC streaming using a KVS Signaling Channel for VIEWER.
 */
const viewer = {};

async function startViewer(remoteView, viewerValues, onStatsReport) {
